...
final class DateLemmyFormatTests: XCTestCase {
    func testWithNanosecLemmy0_19() throws {
        let date = try Date(lemmyFormat: "2023-06-17T09:22:01.123456Z")
        ...
        XCTAssertEqual(components.nanosecond, 122_999_906)
        XCTAssertEqual(components.timeZone?.identifier, "GMT")

        XCTAssertEqual(date.timeIntervalSince1970, 1_686_993_721.123)
    }
