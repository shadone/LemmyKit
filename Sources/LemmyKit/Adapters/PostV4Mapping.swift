...
/// Builds the neutral `Post` for a v4 `Components.Schemas.Post`.
///
...
/// `V4DateParsing.swift`) since the generated type carries them as `String`, not `Date`.
///
...
func neutralPost(fromV4 post: LemmyKitV4Generated.Components.Schemas.Post) -> Post {
    Post(
        id: post.id,
        name: post.name,
        body: post.body,
