...
public extension LemmyApi {
    ...
    ///   - sidebar: sidebar markdown text; when nil, the server's default applies.
    ///   - description: short site description; when nil, the server's default applies.
    ///   - icon: url of the site icon image; when nil, the server's default applies.
    ///   - banner: url of the site banner image; when nil, the server's default applies.
