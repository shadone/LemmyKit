...
///
/// Mirrors v4's `Notification` schema (renamed here to `NotificationEntry` to avoid colliding
/// with `Foundation.Notification` in consumers that import both). See
...
public struct NotificationEntry: Sendable, Equatable {
    ...
    /// `CommentReplyNotificationV3Mapping.swift` and its siblings). A v4-backed `NotificationEntry`
